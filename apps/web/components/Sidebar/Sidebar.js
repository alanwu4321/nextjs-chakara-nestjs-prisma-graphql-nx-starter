...
function Sidebar(props) {
  ...
  const createLinks = (routes) => {
    ...
    return routes.map((prop, key) => {
        ...
        return (
          <>
            <Text
              ...
              py="12px"
            >
              {typeof window === "undefined" ? null : document.documentElement.dir === "rtl"
                ? prop.rtlName
                : prop.name}
            </Text>
      ...
      return (
        <NextLink href={prop.layout + prop.path}>
  ...
  return (
    ...
    >
      ...
      <Drawer
        isOpen={isOpen}
        onClose={onClose}
        placement={typeof window === "undefined" ? null : (document.documentElement.dir === "rtl" ? "right" : "left")}
